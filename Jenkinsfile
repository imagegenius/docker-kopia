pipeline {
  ...
  environment {
    ...
    EXT_USER = 'kopia'
    EXT_REPO = 'kopia'
    BUILD_VERSION_ARG = 'KOPIA_VERSION'
    IG_USER = 'imagegenius'
    IG_REPO = 'docker-kopia'
    CONTAINER_NAME = 'kopia'
    DOCKERHUB_IMAGE = 'imagegenius/kopia'
    DEV_DOCKERHUB_IMAGE = 'igdev/kopia'
    PR_DOCKERHUB_IMAGE = 'igpipepr/kopia'
    DIST_IMAGE = 'alpine'
    MULTIARCH = 'true'
    CI = 'true'
    CI_WEB = 'true'
    ...
    CI_SSL = 'false'
    CI_DELAY = '30'
    CI_DOCKERENV = 'USERNAME=kopia|PASSWORD=kopia'
    CI_AUTH = 'kopia:kopia'
    CI_WEBPATH = ''
  }
  stages {
    ...
    stage('Build-Single') {
      ...
      steps {
        ...
        sh "docker build \
          ...
          --label \"org.opencontainers.image.url=https://github.com/imagegenius/docker-kopia/packages\" \
          --label \"org.opencontainers.image.source=https://github.com/imagegenius/docker-kopia\" \
          ...
          --label \"org.opencontainers.image.description=[Kopia](https://kopia.io/) is a fast and secure open-source backup/restore tool that allows you to create encrypted snapshots of your data and save the snapshots to remote or cloud storage of your choice, to network-attached storage or server, or locally on your machine. Kopia does not 'image' your whole machine. Rather, Kopia allows you to backup/restore any and all files/directories that you deem are important or critical.\" \
